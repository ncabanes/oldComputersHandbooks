...
programming. If you write and then run the programs in the order 
they are presented in, when you have finished reading this book 
you should be able to write simple programs by yourself, as well 
...
This command generates the line 
AUTO numbers automatically on the 
screen. 
Format 
V AUTO beginning line number, increment ‘ 
When the first line number parameter is omitted, a value of B is 
entered. If the increment parameter is omitted a value of lfl is 
entered. 
...
AUTO ,IB ............ .. line numbers are written from line 
0 in increments of lfl 
AUTO ................. .. line numbers are written from line 
I0 in increments of I0 
In order to stop automatic line number generation, press the 
key while holding the key down. 
...
1?
‘I 
You don't have to take the trouble to enter a new ‘k 
nrv9ram- 11" 
10

This command defines the operations 
of the functions keys. 
Format 
I KEY function key number, character format I 
The function keys are numbered from 1 to I0. A character string 
of up to 15 characters can be defined for any one key, but only 
five characters can be displayed on the screen. 
I KEY6, "PRINT" I 
Function key is defined as PRINT. 
Check to see if there were any mistakes when the program was 
entered. If it's correct, let's try and run the program. 
i RUN i 
ll
...
on the screen 
LIST Z0 ......................... .. Only line 20 is displayed on 
the screen 
LIST 20- ...................... .. All the lines from line 20 to 
the end of the program are 
displayed on the screen 
LIST — 50 ...................... .. All lines up to line 50 are 
displayed on the screen 
LIST 30-60................... .. Lines 30 to 60 are displayed 
on the screen 
0 How to correct a program. 
...
iw i 
When a line number is entered and the RETURN key is pressed, 
the computer erases that line number. 
lfl REM PROGRAM #1 ‘ 
28 A =10 : B = 5 
30 PRINT A;B 
40 PRINT At B 
...
Format 
This command is used to correct 
line numbers 
i RENUM new line number, old line number, increment i 
If the new line number is omitted. a value of 10 is entered. If the 
old line number is omitted the first line number at the beginning 
of the program is entered. 
ted a value of 10 is used 
When the increment parameter is omit- 
RENUM l,l0,l..... 
RENUM I00 ...... .. 
RENUM 100,30 
RENUM ,50 ....... .. 
RENUM ,50,5 .... .. 
Line number I0 is changed to 1. The 
line numbers after that increase by I. 
The first line number is changed to 
100, and the following line numbers increase 
by 10. 
Line number 30 is changed to I00. The 
line numbers after that increase by 10. 
Line number 50 is changed to I0. The 
lines after that increase by 10. 
Line number 50 is changed to I0. The 
...
2: green 6: dark red I0: yellow 14: gray 
...
40 PAINT (70,40), 5 
50 LINE (25,1l0)—(50,90), 6 
60 LINE (50,90)—(80,110), 6 
70 LINE (80,110)—(25,Il0), 6 
80 PAINT (50,100), 6 
I00 LINE (35,l40)—(45,1l5), I, 
110 LINE (53,l25)—(60,l15), 3, 
...
line 
I 30 LINE(0,l40)— (255,140), S I 
This command draws a line from point A (0,140) to point 
B(255,l00) in color number 5 (light blue). 
57
...
Format 
i LINE (starting point)—(ending point), color code, B ‘ 
...
Format 
PAINT (starting point), color, color of high resolution i 
...
CIRCLE 
i 120 ClRCLE(l5fl,l2l3), 45,15 i 
...
C1110 14 l'!'l 
llll 15 ‘T1 
I To convert a binary to a hexadecimal number 
llflllflflfl fllfllflflfl 
ll ll 
D8 50 
...
Hey are there really that many black keys? % é ‘ __ ___’, _ 
_i-;’.-§./ Kl "' >1 
- llgrit’ 
90
...
note note note 
musical symbol °' 
tonelength 04-J J+J J+fi [L13 ‘ht’ $,,) 
...
50 PAINT ( 56, I36), 2 
60 LINE( I0, 50)—( 60, 114), I0, BF 
76 LINE ( 60, l14)—(llB, 70), 9, BF 
80 LINE (I10, 4fZI)—(I60, I14), I3, BF 
90 LINE (I60, ll4)—(20fl, 60), I2, BF 
I00 LINE (200, 3fl)—(25$, 114), 14, BF 
llfl FOR l=l TO ID 
120 READ X, Y, XI, Yl 
