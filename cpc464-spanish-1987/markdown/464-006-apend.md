...
Esta es una lista de erratas encontradas en el texto original y que han sido corregidas en esta revisión.
 ...
 - Alguna errata poco importante: enpieza (1/16), opcinal (1/36), imprescidible (2/2), softaware (5/4)
 ...
 - SPC no lleva como parámetro "función numérica", sino una "expresión numérica" (5/19)
