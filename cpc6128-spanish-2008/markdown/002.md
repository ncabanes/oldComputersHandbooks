...
sí el ordenador encendido. Ya sabe cómo hacer que el ordenador repita una tarea
...
En respuesta al programa podemos escribir un nombre (por ejemplo, **Juan**) y 
...
La línea 95 comprueba si **NOMBRE\$(x)** es la cadena vacía; si lo es, 
...
Puesto que todas las funciones está ahora en subrutinas (controladas por la 
instrucción **ON el GOSUB**), tienen que terminar en una instrucción 
**RETURN**. De ahí que hayamos incluido las líneas 85, 125, 170 y 200.

¿Recuerda para qué sirve **RETURN**? Hace que BASIC retorne de la subrutina a 
la instrucción siguiente a aquella que invocó la subrutina. En nuestro caso, el 
...
de datos\'. Para impedirlo añadimos la línea
...
(**RETURN**) al menú. Pondremos esta rutina en las líneas 350 y siguientes.  Para no
...
**TEL\$(x)** en el disco: la expresión **#9** que aparece después de **WRITE** 
es un 'indicador de canal' que especifica a qué canal debe el ordenador enviar 
los datos. El ordenador maneja 10 canales:
...
Ya hemos escrito las instrucciones que graban los datos en disco. Ahora nos 
