...
Cuando se ponga al teclado de su CPC664, no dé por supuesto que en la 
...
\'juego de caracteres\' del CPC664.
...
memoria la información numérica que necesita para exhibir el carácter 
en la pantalla. La localización de esa información es función del 
código numérico que se activa al pulsar la tecla. (Cada carácter tiene 
un código asociado; la relación completa se da en el capítulo titulado 
'Para su referencia ...')
...
![](file:img/cpc664_08_016_matrizCaracteres.png)
...
cada uno de los 64 puntos de la matriz. Las combinaciones posibles son 
...
...). Para ello, los operadores lógicos tratan los valores a los que 
son aplicados como grupos de bits y examinan y modifican los bits uno a 
...
![](file:img/cpc664_08_20_symbol.png)
...
el número no llene el formato. Esto se consigue poniendo **\$\$** o ££ en la plantilla:
...
El BASIC del CPC664 permite la definición y el control de hasta ocho ventanas 
...
Cuando termine el programa y haya aparecido **Ready**, pulse \[ENTER\] varias veces 
...
que una de las principales innovaciones del software del CPC664 es su 
capacidad de gestión de las interrupciones desde BASlC; esto hace que 
el BASIC del AMSTRAD sea capaz de realizar acciones simultáneas 
controladas por programa. Esto es lo que se suele denominar 
'multitarea', y se programa con las instrucciones **AFTER** y **EVERY**.
...
El CPC664 mantiene un reloj-de tiempo real. La orden **AFTER** permite que 
...
140 PRINT(TIME-t)/300;"segundos"
150 CLEAR INPUT:ind=1:RETURN
